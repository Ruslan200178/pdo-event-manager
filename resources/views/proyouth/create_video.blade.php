...
<div class="max-w-3xl mx-auto">
    ...
    <div class="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Add Video Entry</h1>
            <p class="text-xs text-gray-500">Record a new participant for the AI Video Competition.</p>
        </div>
        <div>
    ...
    <div class="bg-white rounded-2xl border border-gray-150 shadow-sm overflow-hidden">
        <form action="{{ route('proyouth.video.store') }}" method="POST">
            @csrf
            ...
            <div class="p-6 md:p-8 space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <input type="url" name="video_link" id="video_link" value="{{ old('video_link') }}" placeholder="https://..." class="mt-1.5 block w-full px-3 py-2 text-sm border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-govblue-500 focus:border-govblue-500">
                    </div>
                </div>
            </div>
