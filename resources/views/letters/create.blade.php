...
@section('title', 'Add Letter Entry')
...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-800 tracking-tight">Add Letter Entry</h1>
            <p class="text-xs text-gray-500 mt-1">Record a new letter entry.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl border border-gray-150 shadow-sm overflow-hidden">
        <form action="{{ route('letters.store') }}" method="POST" class="p-6 space-y-6">
            @csrf
